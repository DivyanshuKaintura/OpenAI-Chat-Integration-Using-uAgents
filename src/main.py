...
from agents.OpenAI_agent import OpenAI_agent  # Imports the openai agent configuration
...
if __name__ == "__main__":
    ...
    # Adding the OpenAI_agent to the Bureau's list of managed agents
    bureau.add(OpenAI_agent)
